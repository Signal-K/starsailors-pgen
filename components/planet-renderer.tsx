...
import type { PlanetStats } from "@/lib/planet-config"
import { getBiomeColors } from "@/lib/planet-config"
import { planetVertexShader } from "./planet-shader/planet-vertex-shader"
import { planetFragmentShader } from "./planet-shader/planet-fragment-shader"
import { atmosphereVertexShader, atmosphereFragmentShader } from "./planet-shader/atmosphere-shader"
import { cloudVertexShader, cloudFragmentShader } from "./planet-shader/cloud-shader"

interface PlanetRendererProps {
  planetStats: PlanetStats
}

export function PlanetRenderer({ planetStats }: PlanetRendererProps) {
