...
import { Check, Download, Upload, RefreshCw, Cog, ChevronDown, ChevronUp } from 'lucide-react';
...
const PopoverContent = React.forwardRef(({ className, align = "center", sideOffset = 4, ...props }, ref) => (jsx(PopoverPrimitive.Portal, { children: jsx(PopoverPrimitive.Content, { ref: ref, align: align, sideOffset: sideOffset, className: cn("z-50 w-72 rounded-md border bg-popover p-4 text-popover-foreground shadow-md outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2", className), ...props }) })));
...
function ColorPicker({ color, onChange, label }) {
    ...
    return (jsxs("div", { className: "flex flex-col space-y-1.5", children: [label && jsx(Label, { className: "text-xs", children: label }), jsxs(Popover, { open: isOpen, onOpenChange: setIsOpen, children: [jsx(PopoverTrigger, { asChild: true, children: jsxs("div", { className: "flex h-8 cursor-pointer", children: [jsx("div", { className: "w-8 h-8 rounded-l border border-r-0 border-gray-600", style: { backgroundColor: localColor } }), jsx(Input, { type: "text", value: localColor, onChange: handleInputChange, className: "rounded-l-none w-24 h-8 font-mono text-xs", onClick: (e) => e.stopPropagation() })] }) }), jsx(PopoverContent, { className: "w-auto p-3", side: "right", children: jsx(HexColorPicker, { color: localColor, onChange: handleColorChange }) })] })] }));
}
...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (jsxs(SelectPrimitive.Trigger, { ref: ref, className: cn("flex h-10 w-full items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background data-[placeholder]:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1", className), ...props, children: [children, jsx(SelectPrimitive.Icon, { asChild: true, children: jsx(ChevronDown, { className: "h-4 w-4 opacity-50" }) })] })));
