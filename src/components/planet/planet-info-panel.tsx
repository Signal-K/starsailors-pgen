...
// Update the PlanetInfoPanel to position it in the bottom right corner
...
export function PlanetInfoPanel({ pointInfo, planetStats }: PlanetInfoPanelProps) {
  ...
  return (
    <Html position={[0, 0, 0]} style={{ position: "absolute", right: "20px", bottom: "20px", pointerEvents: "none" }}>
