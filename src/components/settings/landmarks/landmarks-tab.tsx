...
import { structureTypes, getStructureTypeName, createDefaultStructure } from "./structures/structure-types"
...
// Structure types and helper functions
// const structureTypes = ["building", "power_plant", "research_facility", "defense_system"];
...
// const createDefaultStructure = (type: string): Structure => ({
//   id: `STR-${Math.floor(Math.random() * 900 + 100)}`,
//   name: "",
//   type: type,
//   details: {},
// });
        ...
        <Card className="bg-black/60 border-green-500/30 text-green-400">
          ...
          <CardContent className="space-y-4">
            <Tabs defaultValue="info">
              {/* Add a new tab for structures in the TabsList */}
              ...
              <TabsContent value="info" className="pt-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2 mt-4">
                    <Label className="text-green-300 mb-2 block">Structures</Label>
                    {!landmarks[selectedLandmarkIndex].structures ||
                    landmarks[selectedLandmarkIndex].structures.length === 0 ? (
                      <div className="p-4 bg-black/50 border border-green-500/30 rounded text-center text-green-500/70">
                        No structures added to this landmark
                      </div>
                    ) : (
                      <div className="space-y-2">
                        {landmarks[selectedLandmarkIndex].structures?.map((structure) => (
                          <div key={structure.id} className="p-2 bg-black/50 border border-green-500/30 rounded">
                            <div className="flex justify-between items-center">
                              <div className="flex items-center gap-2">
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  const updatedStructures =
                                    ...
                                    []
                                  updateLandmark(selectedLandmarkIndex, "structures", updatedStructures)
                                }}
                                className="h-6 w-6 p-0 text-green-400 hover:text-red-400 hover:bg-transparent"
                              >
                                <Trash2 className="h-4 w-4" />
                    ...
                    {/* Add structure form */}
                    <div className="mt-4 p-3 border border-green-500/30 rounded-md">
                      <Label className="text-green-300 mb-2 block">Add New Structure</Label>
                      ...
                      <Button
                        ...
                        className="w-full mt-3 bg-green-700 hover:bg-green-600 text-black"
                      >
